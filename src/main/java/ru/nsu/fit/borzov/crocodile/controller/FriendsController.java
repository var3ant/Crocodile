...
public class FriendsController {
    ...
    public List<NameUserResponse> getSentRequests(Principal principal) throws UserNotFoundException {
    ...
    public List<NameUserResponse> getReceivedRequests(Principal principal) throws UserNotFoundException {
        var userId = principalUtils.getUserId(principal);
    ...
    public void sendFriendRequest(@PathVariable Long anotherUserId, Principal principal) throws UserNotFoundException {
        var userId = principalUtils.getUserId(principal);
    ...
    public void declineFriendRequest(@PathVariable Long anotherUserId, Principal principal) throws UserNotFoundException {
        var userId = principalUtils.getUserId(principal);
    ...
    public boolean cancelFriendRequest(@PathVariable Long anotherUserId, Principal principal) throws UserNotFoundException {
        var userId = principalUtils.getUserId(principal);
    ...
    public void delete(@PathVariable Long anotherUserId, Principal principal) throws UserNotFoundException {
        var userId = principalUtils.getUserId(principal);
    ...
    @GetMapping
    public Collection<FriendResponse> getAll(Principal principal) throws UserNotFoundException {
        var userId = principalUtils.getUserId(principal);
    ...
    public Collection<PotentialFriendResponse> potentialBy(Principal principal, @RequestParam String name) throws UserNotFoundException {
        var userId = principalUtils.getUserId(principal);
